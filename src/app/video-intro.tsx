  ...
  return (
    <div className="p-8">
      <div className="w-full container px-5 overflow-hidden rounded-xl relative mx-auto mt-20 max-w-6xl">
        <div className="bg-black/25 dark:bg-black/50 z-10 absolute w-full h-full inset-0 rounded-xl" />
        <Image
          width={768}
          height={400}
        ...
        <div className="absolute top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 z-10">
          <IconButton color="white" className="rounded-full p-2" size="lg">
            <PlayIcon className="h-10 w-10" /> {/* Adjusted icon size */}
          </IconButton>
        </div>
      </div>
    </div>
