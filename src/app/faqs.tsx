...
export function Faqs() {
  return (
    <section className="px-8 py-20 dark:bg-gray-900 dark:text-gray-300"> {/* Dark mode classes */}
      <div className="container max-w-6xl mx-auto">
        <div className="text-center">
          ...
          <Typography
            variant="lead"
            className="mx-auto mb-24 !text-gray-500 dark:!text-gray-400 lg:w-3/5"
          >
        ...
        <div className="grid gap-20 md:grid-cols-1 lg:grid-cols-3">
          {FAQS.map(({ title, desc }) => (
            <Card key={title} shadow={false} color="transparent">
              <Typography color="blue-gray" className="pb-6 dark:text-white" variant="h4">
                {title}
              </Typography>
              <div className="pt-2">
