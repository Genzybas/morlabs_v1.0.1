...
export function MobileConvenience() {
  return (
    <section className="py-20 px-8 dark:bg-gray-900 dark:text-gray-300"> {/* Dark mode support */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
        ...
        <div className="col-span-1 mx-auto max-w-lg px-4 lg:px-0">
          ...
          <Typography
            variant="lead"
            className="mb-5 px-4 text-left text-xl !text-gray-500 dark:!text-gray-300 lg:px-0"
          >
